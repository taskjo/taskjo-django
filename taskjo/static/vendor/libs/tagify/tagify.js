 ...
 */
 ...
 (function () {
   ...
   //------------------------------------------------------
   const TagifyCustomInlineSuggestionEl = document.querySelector('#skill');
   const TagifyCustomInlineSuggestionE2 = document.querySelector('#skill-profile');
   ...
   let TagifyCustomInlineSuggestion2 = new Tagify(TagifyCustomInlineSuggestionE2, {
     whitelist: whitelist,
     maxTags: 5,
     dropdown: {
       maxItems: 20,
   ...
   function tagTemplate(tagData) {
     ...
     >
       ...
       <div>
         <div class='tagify_tag_avatar-wrap'>
   ...
   function suggestionItemTemplate(tagData) {
     ...
     <div ${this.getAttributes(tagData)}
       class='tagify_dropdown_item align-items-center ${tagData.class ? tagData.class : ''}'
       tabindex="0"
       role="option"
     >
       ${
         tagData.avatar
           ? `<div class='tagify_dropdownitem_avatar-wrap'>
           <img onerror="this.style.visibility='hidden'" src="${tagData.avatar}">
         </div>`
           : ''
       }
